...
// WILL USE INTERFACE FROM IMPORT
// export interface PeriodicElement { // OG
//   name: string;
//   position: number;
//   weight: number;
//   symbol: string;
...
// WILL USE 'breweries: Array<Brewery>' data from API response
// const ELEMENT_DATA: PeriodicElement[] = [ // OG
//   {
//     position: 1,
//     name: 'Hydrogen',
//     weight: 1.0079,
